...
namespace AgOpenGPS
{
    public partial class FormGPS
    {
        ...
        private void menuLanguagePortugues_Click(object sender, EventArgs e)
        {
            SetLanguage("pt-br", true);
        }
        ...
        private void SetLanguage(string lang, bool Restart)
        {
            ...
            menuLanguagePortugues.Checked = false;
            ...
            switch (lang)
            {
                ...
                case "pt-br":
                    menuLanguagePortugues.Checked = true;
                    break;
