...
namespace AgOpenGPS
{
    ...
    public class CSection
    {
        ...
        //o lado esquerdo é sempre negativo, o lado direito é positivo
        //então uma seção apenas do lado esquerdo seria -8, -4
        //no centro -4.4 no lado direito apenas 4.8
        ...
        // toda vez que uma nova correção, um novo ponto de correção do último ponto até este ponto
        //só precisa do ponto anterior nos primeiros pontos da tira do triângulo que forma uma caixa (2 triângulos)
