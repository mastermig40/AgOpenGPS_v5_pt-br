  ...
  void SetRelays(void)
  {
      ...
      if (pin[8]) digitalWrite(10, relayState[pin[8]-1]);
      if (pin[9]) digitalWrite(11, relayState[pin[9]-1]);
      if (pin[10]) digitalWrite(12, relayState[pin[10]-1]);
      if (pin[11]) digitalWrite(13, relayState[pin[11]-1]);
      
      if (pin[12]) digitalWrite(14, relayState[pin[12]-1]);
      if (pin[13]) digitalWrite(15, relayState[pin[13]-1]);
      if (pin[14]) digitalWrite(16, relayState[pin[14]-1]);
      if (pin[15]) digitalWrite(17, relayState[pin[15]-1]);
      
      if (pin[16]) digitalWrite(18, relayState[pin[16]-1]);
      if (pin[17]) digitalWrite(19, relayState[pin[17]-1]);
