...
*/
 ...
 { 
    if (aogConfig.isRelayActiveHigh)
    {
      ...
      if (bitRead(relayLo,0)) bitClear(2); //Digital Pin 2
      else bitSet(2); 
      if (bitRead(relayLo,1)) bitClear(3); //Digital Pin 3
      else bitSet(3); 
      if (bitRead(relayLo,2)) bitClear(4); //Digital Pin 4
      else bitSet(4); 
      if (bitRead(relayLo,3)) bitClear(5); //Digital Pin 5
      else bitSet(5); 
      if (bitRead(relayLo,4)) bitClear(6); //Digital Pin 6
      else bitSet(6); 
      if (bitRead(relayLo,5)) bitClear(7); //Digital Pin 7
      else bitSet(7); 
      if (bitRead(relayLo,6)) bitClear(8); //Digital Pin 8
      else bitSet(8); 
      if (bitRead(relayLo,7)) bitClear(9); //Digital Pin 9
      else bitSet(9); 

      if (bitRead(relayLo,8)) bitClear(10); //Digital Pin 10
      else bitSet(10); 
